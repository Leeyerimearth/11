	   ...
	   //==> 주민번호 유효성 check 는 이해정도로....
		...
		function PortalJuminCheck(fieldValue){
			 ...
			 $.ajax({
				 ...
				 success : function(serverData, status){
					...
					// alert(JSONData);
					 ...
					 if(JSONData.result && $.trim(JSONData.userId) != ""){ //공백은 안댄당!
						 resultString = JSONData.userId+"는 사용 가능 합니다.";
					 }
					 else if (JSONData.result == false){
						 resultString = JSONData.userId+"는 사용 불가능 합니다."; 
					 }
					 else{
						 resultString= "";
					 }
		 ...
		 $(function() {
			...
			//얘를 아예 checkDuplication.jsp에서 하는걸로 바꿔야한다. 
			/* 
			//==> DOM Object GET 3가지 방법 ==> 1. $(tagName) : 2.(#id) : 3.$(.className)
