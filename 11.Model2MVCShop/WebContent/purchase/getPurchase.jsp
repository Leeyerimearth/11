...
<script type="text/javascript">
	$(function() {
		...
		$(".ct_btn01:contains('구매취소')")
		.on(
				"click",
				function() {
					self.location = "/purchase/updateTranCode?tranNo=${purchase.tranNo}&tranCode=005";
		});
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			...
			<td class="ct_write01"><c:if
					test="${purchase.paymentOption=='cd '}">
				카드구매
			</c:if> <c:if test="${purchase.paymentOption=='ca '}">
				현금구매
			</c:if></td>
		</tr>
		<tr>
