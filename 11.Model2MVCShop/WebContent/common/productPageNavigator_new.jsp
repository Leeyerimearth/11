		  ...
		  <ul class="pagination" >
			...
			<c:forEach var="i"  begin="${resultPage.beginUnitPage}" end="${resultPage.endUnitPage}" step="1">
		     ...
		     <c:if test="${ resultPage.currentPage == resultPage.maxPage }">
		  		<li class="disabled">
		  		<a href="javascript:fncGetProductList('${resultPage.currentPage}')" aria-label="Next">
			</c:if>
			<c:if test="${ resultPage.currentPage < resultPage.maxPage }">
				<li>
				<a href="javascript:fncGetProductList('${resultPage.currentPage+1}')" aria-label="Next">
			</c:if>
